    ...
    <div className="mb-6 bg-white/95 backdrop-blur-xl rounded-2xl p-4 sm:p-6 border border-indigo-200/50 shadow-lg">
      <div className="flex flex-col xl:flex-row gap-4 items-start xl:items-center justify-between">
        ...
        <div className="flex flex-wrap gap-3 w-full xl:w-auto">
          <button 
            onClick={onAddUser}
            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-500 to-cyan-500 text-white rounded-lg hover:from-indigo-600 hover:to-cyan-600 transition-all duration-200 shadow-lg"
          >
            <UserPlus size={16} />
